            ...
            <div id="content">
                ...
                <div class="box round">
                    <c:if test="${not empty school}">
                        ...
                        <a href="${startPath}student-list?school=${school.id}">
                            <spring:message code="label.students"/></a>
                        </c:if>
                </div>
                ...
                <div class="box round">
                    <form action="${startPath}save-student" method="post" enctype="application/x-www-form-urlencoded">
                        ...
                        <table id="enter">
                            <tr>
                                ...
                                <td><input type="text" disabled value="${student.iin}"/></td>
                            </tr>
                            <tr>
                                <td><spring:message code="label.last-name"/></td>
                                <td><input type="text" name="student-f" value="${student.f}"/></td>
                            </tr>
                            <tr>
                                <td><spring:message code="label.first-name"/></td>
                                <td><input type="text" name="student-i" value="${student.i}"/></td>
                            </tr>
                            <tr>
                                <td><spring:message code="label.middle-name"/></td>
                                <td><input type="text" name="student-o" value="${student.o}"/></td>
                            </tr>
                            <tr>
                                ...
                                <td>
                                    <select name="student-class">
                                        ...
                                        <c:forEach items="${classMap}" var="clazz">
                                            <option value="${clazz.getValue().id}"
                                                    <c:if test="${link.classId eq clazz.getValue().id}">
                                                        selected
                                                    </c:if>
                                                    >${clazz.getValue().getLocalizedName()}</option>
                                        </c:forEach>
                                    </select>
                                </td>
                            </tr>
                            <tr>
                                ...
                                <td><input type="text" name="student-parallel" value="${link.parallel}"/></td>
                            </tr>
