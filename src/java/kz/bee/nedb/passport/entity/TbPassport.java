...
@SequenceGenerator(name="seq_tb_passport", sequenceName="seq_tb_passport", allocationSize=10)

@Entity
@Table(name="tb_passport")
public class TbPassport {
    private Long id;
    private Long passDataId;
    ...
    @Id
    @GeneratedValue(generator="seq_tb_passport", strategy= GenerationType.SEQUENCE)
    @Column(name="id")
    public Long getId() {
        return id;
    }
    ...
    @Column(name="pass_data_id")
    public Long getPassDataId() {
        return passDataId;
    }

    public void setPassDataId(Long passDataId) {
        this.passDataId = passDataId;
    }
