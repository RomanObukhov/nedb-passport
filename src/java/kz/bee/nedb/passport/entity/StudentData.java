...
@SequenceGenerator(allocationSize=10, name="seq_student_data", sequenceName="seq_student_data")
...
public class StudentData {
    ...
    @Id
    @GeneratedValue(generator="seq_student_data", strategy= GenerationType.SEQUENCE)
    @Column(name="id")
    public Long getId() {
        return id;
    }
