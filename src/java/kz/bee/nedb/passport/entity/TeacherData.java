...
@SequenceGenerator(allocationSize=10, name="seq_teacher_data", sequenceName="seq_teacher_data")
...
public class TeacherData {
    ...
    @Id
    @GeneratedValue(generator="seq_teacher_data", strategy= GenerationType.SEQUENCE)
    @Column(name="id")
    public Long getId() {
        return id;
    }
