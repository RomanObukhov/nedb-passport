...
@SequenceGenerator(allocationSize=10, name="seq_tb_student", sequenceName="seq_tb_student")
...
public class TbStudent {
    ...
    @Id
    @GeneratedValue(generator="seq_tb_student", strategy= GenerationType.SEQUENCE)
    @Column(name="id")
    public Long getId() {
        return id;
    }
