...
@SequenceGenerator(name="seq_pass_data", sequenceName="seq_pass_data", allocationSize=10)
...
//    private Long passIndSpLinkId;
    ...
    @Id
    @GeneratedValue(generator="seq_pass_data", strategy= GenerationType.SEQUENCE)
    @Column(name="id")
    public Long getId() {
        return id;
    }
...
//    }
    ...
    public String getCompactNumber() {
        if (numberValue == null) {
            return "";
        } else if (numberValue.intValue() == numberValue.doubleValue()) {
