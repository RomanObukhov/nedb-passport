...
public class StudentElement {
    private static final Logger LOGGER = Logger.getLogger(StudentElement.class);
    ...
    private List<StudentData> listStudentData = null;
    private HashMap<Long, List<ClassItemTreeWrapper>> dictMap = new HashMap<Long, List<ClassItemTreeWrapper>>();
    
    private StudentData getPassDataByHeaderCellWrappers(HeaderCellWrapper hHeaderCellWrapper, HeaderCellWrapper vHeaderCellWrapper) {
        ...
        for (StudentData listData: listStudentData) {
            if (listData.match(passDataCoords)) {
                return listData;
            }
        }
        
        StudentData listData = new StudentData();
        listData.setDims(passDataCoords);
        
        return listData;
    }
    
    private String getElementIdFrom(StudentData data) {
...
//                first = false;
    ...
    private List<Long> getListPassDataDims() {
        ...
        for (StudentData data: listStudentData) {
...
//                    .append(FIELD_NUMBER)
                    ...
                    .append(passIndLink.getId())
                    .append("\" value=\"")
                    .append(studentData == null ? "" : studentData.getNumberValue().intValue())
                    .append("\"/></td>")
                    .toString();
        }
    }
...
//                    .append(FIELD_DATE)
                    ...
                    .append(passIndLink.getId())
                    .append("\" value=\"")
                    .append(studentData == null ? "" : Consts.JAVASCRIPT_DATE_FORMAT.format(studentData.getDateValue()))
                    .append("\"/></td>")
                    .toString();
        }
    }
...
//                    .append(FIELD_CHECKBOX)
                    ...
                    .append(passIndLink.getId())
                    .append("\" ")
                    .append(studentData == null ? "" : Boolean.TRUE.equals(studentData.getBooleanValue()) ? "checked" : "")
                    .append("/></td>")
                    .toString();
        }
    }
...
//                        .append(FIELD_COMBOBOX)
                ...
                for (ClassItemTreeWrapper classItemTreeWrapper: classItemTreeWrappers) {
                    stringBuilder.append(classItemTreeWrapper.toOption(0, studentData == null ? null : studentData.getClassItemTreeId()));
                }
...
//                    .append(FIELD_TEXT)
                    ...
                    .append(passIndLink.getId())
                    .append("\" value=\"")
                    .append(studentData == null ? "" : studentData.getStringValue())
                    .append("\"/></td>")
                    .toString();
        }
    }
        ...
        if (passIndLink == null) {
            ...
            for (int i = 0; i < vHeaderCellWrappers.size(); i ++) {
                ...
                for (int j = 0; j < hHeaderCellWrappers.size(); j++) {
                    ...
                    StudentData listData = getPassDataByHeaderCellWrappers(hHeaderCellWrapper, vHeaderCellWrapper);
...
//                stringBuilder.append(classItemTreeWrapper.toListItem(getListPassDataDims(), FIELD_BOOLGROUP + "-" + passIndLink.getId()));
    ...
    public StudentElement(PassIndLink passIndLink, Measure measure, Indicator indicator) {
        super();
    ...
    public void setListStudentData(List<StudentData> listStudentData) {
        this.listStudentData = listStudentData;
    }
