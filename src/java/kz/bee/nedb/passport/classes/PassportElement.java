...
public class PassportElement {
    private static final Logger LOGGER = Logger.getLogger(PassportElement.class);
    ...
    private List<PassData> listPassData = null;
...
//    private PassData getPassDataByHeaderCellWrappers(HeaderCellWrapper hHeaderCellWrapper, HeaderCellWrapper vHeaderCellWrapper, PassDataFactory<T> passDataFactory) {
    private PassData getPassDataByHeaderCellWrappers(HeaderCellWrapper hHeaderCellWrapper, HeaderCellWrapper vHeaderCellWrapper) {
        ...
        for (PassData listData: listPassData) {
            if (listData.match(passDataCoords)) {
                return listData;
            }
        }
        
        PassData listData = new PassData();
        listData.setDims(passDataCoords);
        
        return listData;
    }
    
    private String getElementIdFrom(PassData data) {
...
//                first = false;
    ...
    private List<Long> getListPassDataDims() {
        ...
        for (PassData data: listPassData) {
//            result.addAll(data.getDims());
    ...
    private String toNumberEdit() {
        if (passIndLink == null) {
            ...
            String elementId = "field-number-" + passIndLink.getId();
            
            StringBuilder scriptBuilder = new StringBuilder();
            
            if ((passIndLink.getDataformat() != null) && !passIndLink.getDataformat().isEmpty()) {
                scriptBuilder
                        .append("<script type=\"text/javascript\">")
                        .append("(function($){ $(document).ready(function() {")
                        .append("$(\"#")
                        .append(elementId)
                        .append("\").inputmask(")
                        .append(passIndLink.getDataformat())
                        .append(", \"")
                        .append(passIndLink.getLocalizedFormatMessage())
                        .append("\");")
                        .append("});})(jQuery);")
                        .append("</script>");
            }
            
            return new StringBuilder(scriptBuilder.toString())
                    .append("<td valign=\"top\"><strong>")
                    .append(indicator.getLocalizedName())
                    .append(measure == null ? "" : ", " + measure.getLocalizedShortName())
                    .append("</strong></td><td valign=\"top\"><input type=\"text\" name=\"")
//                    .append(FIELD_NUMBER)
                    .append(FIELD_PREFIX)
                    .append("-")
                    ...
                    .append(elementId)
                    .append("\" value=\"")
                    .append(passData == null ? "" : passData.getCompactNumber())
                    .append("\"/></td>")
                    .toString();
        }
    }
    ...
    private String toDateEdit() {
        if (passIndLink == null) {
            ...
            return new StringBuilder("<td valign=\"top\"><strong>")
                    .append(indicator.getLocalizedName())
                    .append(measure == null ? "" : ", " + measure.getLocalizedShortName())
                    .append("</strong></td><td valign=\"top\"><input type=\"text\" name=\"")
//                    .append(FIELD_DATE)
                    ...
                    .append(passIndLink.getId())
                    .append("\" value=\"")
                    .append(passData == null ? "" : Consts.JAVASCRIPT_DATE_FORMAT.format(passData.getDateValue()))
                    .append("\"/></td>")
                    .toString();
        }
    }
    ...
    private String toCheckbox() {
        if (passIndLink == null) {
            ...
            return new StringBuilder("<td valign=\"top\"><strong>")
                    .append(indicator.getLocalizedName())
                    .append(measure == null ? "" : ", " + measure.getLocalizedShortName())
                    .append("</strong></td><td valign=\"top\"><input type=\"checkbox\" name=\"")
//                    .append(FIELD_CHECKBOX)
                    ...
                    .append(passIndLink.getId())
                    .append("\" ")
                    .append(passData == null ? "" : Boolean.TRUE.equals(passData.getBooleanValue()) ? "checked" : "")
                    .append("/></td>")
                    .toString();
        }
    }
    ...
    private String toCombobox() {
        if (passIndLink == null) {
            ...
            if ((classItemTreeWrappers == null) || classItemTreeWrappers.isEmpty()) {
                ...
                StringBuilder stringBuilder = new StringBuilder("<td valign=\"top\"><strong>")
                        .append(indicator.getLocalizedName())
                        .append(measure == null ? "" : ", " + measure.getLocalizedShortName())
                        .append("</strong></td><td valign=\"top\"><select name=\"")
//                        .append(FIELD_COMBOBOX)
                ...
                for (ClassItemTreeWrapper classItemTreeWrapper: classItemTreeWrappers) {
                    stringBuilder.append(classItemTreeWrapper.toOption(0, passData == null ? null : passData.getClassItemTreeId()));
                }
    ...
    private String toTextEdit() {
        if (passIndLink == null) {
            ...
            String elementId = "field-text-" + passIndLink.getId();
...
//                    .append(FIELD_TEXT)
                    ...
                    .append(elementId)
                    .append("\" value=\"")
                    .append(passData == null ? "" : passData.getStringValue())
                    .append("\"/></td>")
                    .toString();
        }
    }
    ...
    private String toMultilineEdit() {
        if (passIndLink == null) {
            ...
            return new StringBuilder("<td valign=\"top\" class=\"dotted-border\"><strong>")
                    .append(indicator.getLocalizedName())
                    .append(measure == null ? "" : ", " + measure.getLocalizedShortName())
                    .append("</strong></td><td valign=\"top\"><textarea name=\"")
    ...
    private String toTable() {
        if (passIndLink == null) {
            ...
            StringBuilder stringBuilder = new StringBuilder("<td valign=\"top\"><strong>")
                    .append(indicator.getLocalizedName())
                    .append(measure == null ? "" : ", " + measure.getLocalizedShortName())
                    .append("</strong></td><td valign=\"top\"><table id=\"enter\">");
            ...
            for (int i = 0; i < vHeaderCellWrappers.size(); i ++) {
                ...
                for (int j = 0; j < hHeaderCellWrappers.size(); j++) {
                    ...
                    PassData listData = getPassDataByHeaderCellWrappers(hHeaderCellWrapper, vHeaderCellWrapper);
    ...
    private String toBooleanGroup() {
        if (passIndLink == null) {
            ...
            StringBuilder stringBuilder = new StringBuilder("<td valign=\"top\"><strong>")
                    .append(indicator.getLocalizedName())
                    .append(measure == null ? "" : ", " + measure.getLocalizedShortName())
                    .append("</strong></td><td valign=\"top\" id=\"field-boolgroup-tree-")
                    .append(passIndLink.getId())
                    .append("\"><ul>");
...
//                stringBuilder.append(classItemTreeWrapper.toListItem(getListPassDataDims(), FIELD_BOOLGROUP + "-" + passIndLink.getId()));
    ...
    public PassportElement(PassIndLink passIndLink, Measure measure, Indicator indicator) {
        super();
    ...
    public List<PassData> getListPassData() {
        return listPassData;
    }

    public void setListPassData(List<PassData> listPassData) {
        this.listPassData = listPassData;
    }
